...
<body class=" bg-zinc-900">
  ...
  <nav class="navbg bg-gray-950 w-full fixed top-0 left-0 z-11 py-2 shadow-lg">
    <div data-aos="fade-in" data-aos-duration="1000"
      ...
      <!-- menu dekstop -->
      <div id="nav-menu" class="hidden text-neutral-50 md:flex gap-6 font-jac">
        ...
        <button
          class="toggleMode bg-button p-3 bg-gray-900 rounded-full mx-4 cursor-pointer hover:text-teal-400 transition Text"> <span>Dark</span></button>
      </div>
    </div>
  </nav>
  <!-- Menu mobile -->
  <div id="mobile-menu"
    ...
    <a href="#contact" class="Text-nav p-3 hover:text-teal-400 transition ">Contact</a>
    <button
      class="toggleMode bg-button p-3 bg-stone-900 rounded-full cursor-pointer hover:text-teal-400 transition Text">Dark</button>
  </div>
  ...
  <div class="-mt-10 md:-mt-20">
    ...
    <svg data-aos="fade-up" data-aos-duration="1000" class="svg" xmlns="http://www.w3.org/2000/svg"
    ...
    <div data-aos="fade-up" data-aos-duration="1000" class="flex justify-center items-center -mt-22 md:-mt-28">
  ...
  <section class="flex justify-center items-center">
    <div class="grid">
      ...
      <div data-aos="fade-up" data-aos-duration="1000" class="bg bg-gray-900 p-4 rounded-lg m-4 md:p-10">
  ...
  <section id="contact" class="py-16">
    <div class="container mx-auto px-6 text-center">
      ...
      <div data-aos="fade-up" data-aos-duration="1000" class="max-w-md mx-auto bg bg-gray-900/50 p-8 rounded-xl">
        ...
        <div class="space-y-4">
          ...
          <p class="Text text-gray-300">
            <a href="https://www.instagram.com/xlarvaton" class="font-semibold text-teal-400">Instagram:
              <span class="Text text-neutral-50">@xlarvaton</span>
          ...
          <p class="Text text-gray-300">
            <a href="https://github.com/theLarvathon" class="font-semibold text-teal-400">GitHub:
              ...
              <span class="Text text-neutral-50">thelarvathon</span>
            </a>
          </p>
        </div>
      </div>
  ...
  <!-- Footer -->
  <footer class="navbg bg-gray-950 py-6 mt-10">
    <div class="container w-full px-6 text-center text-gray-400 font-quicksand">
      <p class="Text">&copy; 2026 Syafik Dev. All rights reserved.</p>
      <p class="text-sm Text mt-2">Built with Tailwind CSS</p>
    </div>
  </footer>
